...
description: "Learn how function-granular kernel address space layout randomization strengthens Linux against control-flow hijacking with minimal runtime overhead."
excerpt: "An introduction to ASLR, KASLR, and function-level kernel randomization."
topic: "Security Research"
image: "/assets/sec-eng/img/fgkaslr.png"
toc: true
redirect_from:
  - /kernel/security/2023/02/23/fgkaslr-1.html
author_profile: true
author: pirate
---
...
![Stack-smashing attack overwriting a return address](/assets/sec-eng/img/stack_smashing.png "Figure 1: Stack-smashing")
...
![Address space layout randomized between process executions](/assets/sec-eng/img/aslr_orig.png "Figure 2: ASLR example")
...
Figure 3: KASLR
![Kernel binary relocated as a single randomized block by KASLR](/assets/sec-eng/img/kaslr.png "Figure 3: KASLR")
...
Figure 4: FGKASLR
![Kernel functions independently shuffled in memory by FGKASLR](/assets/sec-eng/img/fgkaslr.png "Figure 4: FGKASLR")
